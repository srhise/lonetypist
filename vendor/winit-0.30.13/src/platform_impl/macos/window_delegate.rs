...
impl WindowDelegate {
    ...
    pub fn set_blur(&self, _blur: bool) {
        // Window blur was only reachable through CGSSetWindowBackgroundBlurRadius,
        // a private API; App Review rejects any binary that references it. winit
        // 0.31 reimplements this on the public NSVisualEffectView, but that is
        // still a beta with a different API, so here the call is simply gone.
        // Nothing in this application asks for blur.
    }
